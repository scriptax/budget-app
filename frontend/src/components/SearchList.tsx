...
const ListBtn = ({ text, openHandler }: ListBtnTypes): ReactElement => {
  return (
    <button
      onClick={openHandler}
      type="button"
      className="w-full border-0 outline-none py-2 text-slate-800 rounded-md cursor-pointer text-md bg-slate-100 active:translate-y-1 transition-transform outline-offset-0 focus:outline-slate-600 duration-100 px-3 flex justify-between items-center"
    >
